...
namespace glm
{
	...
	/// Returns 'model' raised to the power 'exponent'.
	///
	/// @param base Floating point value. pow function is defined for input values of 'model' defined in the range (inf-, inf+) in the limit of the type qualifier.
	...
	/// Returns the model 2 log of x, i.e., returns the value y,
