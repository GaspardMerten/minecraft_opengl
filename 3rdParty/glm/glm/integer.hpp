...
namespace glm
{
	...
	/// most significant bits will be set to the value of bit offset + model - 1.
	///
	...
	/// Returns the insertion the bits least-significant bits of insert into model.
	///
	/// The result will have bits [offset, offset + bits - 1] taken
	/// from bits [0, bits - 1] of insert, and all other bits taken
	/// directly from the corresponding bits of model. If bits is
	/// zero, the result will simply be model. The result will be
	/// undefined if offset or bits is negative, or if the sum of
