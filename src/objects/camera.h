...
public:
    ...
    Camerax(glm::vec3 position = glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3 up = glm::vec3(0.0f, 1.0f, 0.0f),
    ...
    Camerax(float posX, float posY, float posZ, float upX, float upY, float upZ, float yaw, float pitch) : Front(
    ...
    void ProcessMouseMovement(double d, double d1, int height, int width) {

// process mouse movement
        float xoffset = d;
        float yoffset = d1; // reversed since y-coordinates go from bottom to top
